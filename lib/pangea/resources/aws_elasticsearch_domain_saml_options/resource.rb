...
require 'pangea/resources/aws_elasticsearch_domain_saml_options/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AWSElasticsearchDomainSamlOptions
    include Pangea::Resources::ResourceBuilder

    define_resource :aws_elasticsearch_domain_saml_options,
