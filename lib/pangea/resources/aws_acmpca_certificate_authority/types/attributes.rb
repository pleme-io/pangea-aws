    ...
    module AWS
      module Types
        ...
        class AcmPcaCertificateAuthorityAttributes < Pangea::Resources::BaseAttributes
          ...
          # Usage mode
          attribute? :usage_mode, Resources::Types::String.constrained(included_in: ['GENERAL_PURPOSE', 'SHORT_LIVED_CERTIFICATE']).optional

          # Key storage security standard
          attribute? :key_storage_security_standard, Resources::Types::String.constrained(included_in: ['FIPS_140_2_LEVEL_2_OR_HIGHER', 'FIPS_140_2_LEVEL_3_OR_HIGHER']).optional
