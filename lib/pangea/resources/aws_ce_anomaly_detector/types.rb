  ...
  module Resources
    module AWS
      module Types
        ...
        AnomalyDetectorType = Resources::Types::String.constrained(included_in: ['DIMENSIONAL', 'SERVICE'])
        
        # Anomaly monitor types  
        AnomalyMonitorType = Resources::Types::String.constrained(included_in: ['DIMENSIONAL', 'CUSTOM'])
        
        # Frequency for anomaly detection
        AnomalyDetectorFrequency = Resources::Types::String.constrained(included_in: ['DAILY', 'IMMEDIATE'])
        
        # Dimension key for anomaly detection
        AnomalyDimensionKey = Resources::Types::String.constrained(included_in: ['AZ', 'INSTANCE_TYPE', 'LINKED_ACCOUNT', 'OPERATION', 'PURCHASE_TYPE',
        ...
        class AnomalyDetectorAttributes < Dry::Struct
          ...
          attribute :match_options?, Resources::Types::Array.of(Resources::Types::String).optional
          attribute :dimension_values?, Resources::Types::Array.of(Resources::Types::String).optional
