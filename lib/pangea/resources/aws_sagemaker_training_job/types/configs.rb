      ...
      module Types
        SageMakerTrainingDataSource = Resources::Types::Hash.schema(
          s3_data_source: Resources::Types::Hash.schema(s3_data_type: Resources::Types::String.constrained(included_in: ['ManifestFile', 'S3Prefix', 'AugmentedManifestFile']),
                                       ...
                                       attribute_names?: Resources::Types::Array.of(Resources::Types::String).optional)
        )
        ...
        SageMakerTrainingInputDataConfig = Resources::Types::Hash.schema(
          ...
          input_mode?: SageMakerTrainingInputMode.default('File'), shuffle_config?: Resources::Types::Hash.schema(seed: Resources::Types::Integer.constrained(gteq: 0, lteq: 4_294_967_295)).optional
        )

        SageMakerTrainingOutputDataConfig = Resources::Types::Hash.schema(kms_key_id?: Resources::Types::String.optional, s3_output_path: Resources::Types::String.constrained(format: /\As3:\/\//))
        SageMakerTrainingResourceConfig = Resources::Types::Hash.schema(instance_count: Resources::Types::Integer.constrained(gteq: 1, lteq: 100), instance_type: SageMakerTrainingInstanceType,
                                                       volume_size_in_gb: Resources::Types::Integer.constrained(gteq: 1, lteq: 16_384), volume_kms_key_id?: Resources::Types::String.optional)
        SageMakerTrainingStoppingCondition = Resources::Types::Hash.schema(max_runtime_in_seconds?: Resources::Types::Integer.constrained(gteq: 1, lteq: 432_000).default(86_400))
        ...
        SageMakerTrainingCheckpointConfig = Resources::Types::Hash.schema(s3_uri: Resources::Types::String.constrained(format: /\As3:\/\//), local_path?: Resources::Types::String.default('/opt/ml/checkpoints'))
        SageMakerTrainingDebugHookConfig = Resources::Types::Hash.schema(local_path?: Resources::Types::String.default('/opt/ml/output/tensors'), s3_output_path: Resources::Types::String.constrained(format: /\As3:\/\//),
                                                        hook_parameters?: Resources::Types::Hash.map(Resources::Types::String, Resources::Types::String).optional, collection_configurations?: Resources::Types::Array.of(Resources::Types::Hash).optional)
        SageMakerTrainingProfilerConfig = Resources::Types::Hash.schema(s3_output_path?: Resources::Types::String.constrained(format: /\As3:\/\//).optional,
                                                       ...
                                                       profiling_parameters?: Resources::Types::Hash.map(Resources::Types::String, Resources::Types::String).optional)
      end
    end
  end
end
