  ...
  module Resources
    module AWS
      module Types
        ...
        class CognitoUserPoolClientTokenValidityUnits < Pangea::Resources::BaseAttributes
        ...
        class CognitoUserPoolClientAnalyticsConfiguration < Pangea::Resources::BaseAttributes
