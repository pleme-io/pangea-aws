...
require 'pangea/resources/aws_opsworks_static_web_layer/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AWSOpsworksStaticWebLayer
    include Pangea::Resources::ResourceBuilder

    define_resource :aws_opsworks_static_web_layer,
      attributes_class: AWS::Types::OpsworksStaticWebLayerAttributes,
      outputs: { id: :id },
      map: [:stack_id],
