  ...
  module Resources
    module AWS
      module Types
        ...
        class EmrClusterAttributes < Pangea::Resources::BaseAttributes
          extend EmrClusterClassMethods
          include EmrClusterInstanceMethods
          extend EmrClusterValidation

          attribute? :name, Resources::Types::String.optional
          attribute? :release_label, Resources::Types::String.optional
          ...
          attribute? :configurations, Resources::Types::Array.of(
            Resources::Types::Hash.schema(classification: Resources::Types::String, configurations?: Resources::Types::Array.of(Resources::Types::Hash).optional,
                               properties?: Resources::Types::Hash.map(Resources::Types::String, Resources::Types::String).lax.optional)
          ).default([].freeze)
          ...
          # Instance groups
          attribute? :master_instance_group, Resources::Types::Hash.schema(instance_type: Resources::Types::String, instance_count?: Resources::Types::Integer.constrained(eql: 1).lax.optional)
          attribute? :core_instance_group, Resources::Types::Hash.schema(
            ...
            ebs_config?: Resources::Types::Hash.schema(ebs_block_device_config?: Resources::Types::Array.of(Resources::Types::Hash).lax.optional, ebs_optimized?: Resources::Types::Bool.optional).optional
          ).optional
          ...
          attribute? :bootstrap_action, Resources::Types::Array.of(
            Resources::Types::Hash.schema(path: Resources::Types::String, name: Resources::Types::String, args?: Resources::Types::Array.of(Resources::Types::String).lax.optional)
          ).default([].freeze)
          ...
          attribute? :auto_termination_policy, Resources::Types::Hash.schema(idle_timeout?: Resources::Types::Integer.optional).lax.optional
          ...
          attribute? :placement_group_configs, Resources::Types::Array.of(
            Resources::Types::Hash.schema(instance_role: Resources::Types::String.constrained(included_in: ['MASTER', 'CORE', 'TASK']).lax, placement_strategy?: Resources::Types::String.constrained(included_in: ['SPREAD', 'PARTITION', 'CLUSTER']).optional)
          ).default([].freeze)
          ...
          def self.new(attributes = {})
            ...
            validate_instance_profile(attrs.ec2_attributes&.dig(:instance_profile))
