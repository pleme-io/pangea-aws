...
require 'pangea/resources/aws_lightsail_lb_https_redirection_policy/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AWSLightsailLbHttpsRedirectionPolicy
    include Pangea::Resources::ResourceBuilder

    define_resource :aws_lightsail_lb_https_redirection_policy,
