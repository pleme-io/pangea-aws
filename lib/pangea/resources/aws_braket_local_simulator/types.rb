  ...
  module Resources
    module AWS
      module Types
        ...
        class BraketLocalSimulatorAttributes < Pangea::Resources::BaseAttributes
          ...
          attribute? :simulator_name, Resources::Types::String.optional
          ...
          def self.new(attributes = {})
            ...
            device_name = attrs.configuration&.dig(:backend_configuration)[:device_name]
            validate_device_consistency(attrs.simulator_type, device_name)

            resource_config = attrs.configuration&.dig(:resource_configuration)
            ...
            shots = attrs.configuration&.dig(:backend_configuration)[:shots]
