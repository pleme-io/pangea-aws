...
require 'pangea/resources/aws_opsworks_ecs_cluster_layer/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AWSOpsworksEcsClusterLayer
    include Pangea::Resources::ResourceBuilder

    define_resource :aws_opsworks_ecs_cluster_layer,
      attributes_class: AWS::Types::OpsworksEcsClusterLayerAttributes,
      outputs: { id: :id },
      map: [:ecs_cluster_arn, :stack_id],
