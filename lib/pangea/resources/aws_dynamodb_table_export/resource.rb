...
module Pangea::Resources
  module AWSDynamodbTableExport
    ...
    define_resource :aws_dynamodb_table_export,
      ...
      map_present: [:export_format, :export_time, :export_type, :incremental_export_specification, :region, :s3_bucket_owner, :s3_prefix, :s3_sse_algorithm, :s3_sse_kms_key_id]
  end
  module AWS
