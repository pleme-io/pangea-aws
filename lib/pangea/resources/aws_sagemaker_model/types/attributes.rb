    ...
    module AWS
      module Types
        ...
        SageMakerModelContainer = Resources::Types::Hash.schema(
          ...
          multi_model_config?: Resources::Types::Hash.schema(model_cache_setting?: Resources::Types::String.constrained(included_in: ['Enabled', 'Disabled']).lax.optional).optional
        )
        ...
        SageMakerModelInferenceExecutionConfig = Resources::Types::Hash.schema(mode: Resources::Types::String.constrained(included_in: ['Serial', 'Direct']).lax)

        class SageMakerModelAttributes < Pangea::Resources::BaseAttributes
          transform_keys(&:to_sym)

          attribute? :model_name, Resources::Types::String.constrained(min_size: 1, max_size: 63, format: /\A[a-zA-Z0-9][a-zA-Z0-9\-]*[a-zA-Z0-9]\z/).optional
          attribute? :execution_role_arn, SageMakerModelExecutionRole.optional
          attribute? :primary_container, SageMakerModelContainer.optional
          attribute :containers, Resources::Types::Array.of(SageMakerModelContainer).default([].freeze)
