    ...
    module SecureVpc
      module Types
        ...
        class SecureVpcAttributes < Dry::Struct
          ...
          attribute :flow_log_destination, Components::Types::String.default('cloud-watch-logs').enum('cloud-watch-logs', 's3')
          attribute :instance_tenancy, Components::Types::String.default('default').enum('default', 'dedicated', 'host')
