...
- **Pillar 5** (Infrastructure declaration): pangea-aws is the AWS provider face of the Pangea DSL. Every AWS resource an architecture can emit is a typed function here.
- **Pillar 12** (Generation over composition): auto-generated by `pangea-forge` from Terraform provider schemas — 1,526+ resources with zero hand-written Ruby. Regenerate the whole gem from the schema; never edit a resource file by hand.
