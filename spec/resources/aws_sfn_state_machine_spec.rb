...
# Resource: Manages a aws_sfn_state_machine resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSSfnStateMachine do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { definition: 'test-value', role_arn: 'test-value' } }

  describe ':aws_sfn_state_machine' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sfn_state_machine('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_sfn_state_machine', 'test')
        validate_required_attributes(config, [:definition, :role_arn])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_sfn_state_machine('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_sfn_state_machine)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.id).to eq("${aws_sfn_state_machine.test.id}")
        expect(ref.arn).to eq("${aws_sfn_state_machine.test.arn}")
        expect(ref.creation_date).to eq("${aws_sfn_state_machine.test.creation_date}")
        ...
        expect(ref.tags_all).to eq("${aws_sfn_state_machine.test.tags_all}")
        expect(ref.version_description).to eq("${aws_sfn_state_machine.test.version_description}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sfn_state_machine('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes publish when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sfn_state_machine('opt', required_attrs.merge(publish: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_sfn_state_machine', 'opt')
        expect(config).to have_key('publish')
      end
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sfn_state_machine('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_sfn_state_machine', 'opt')
        expect(config).to have_key('tags')
      end
      ...
      it 'omits tracing_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sfn_state_machine('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_sfn_state_machine', 'minimal')
        expect(config).not_to have_key('tracing_configuration')
      end
      it 'includes type when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sfn_state_machine('opt', required_attrs.merge(type: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_sfn_state_machine', 'opt')
        expect(config).to have_key('type')
      end
    ...
    context 'boolean fields' do
      [true, false].each do |val|
        it "accepts publish=#{val}" do
          ...
          synth.aws_sfn_state_machine("bool_#{val}", attrs)
          result = normalize_synthesis(synth.synthesis)
          config = validate_resource_structure(result, 'aws_sfn_state_machine', "bool_#{val}")
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sfn_state_machine('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_sfn_state_machine', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sfn_state_machine('first', required_attrs)
        synth.aws_sfn_state_machine('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_sfn_state_machine')
