...
# Resource: Manages a aws_s3control_directory_bucket_access_point_scope resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSS3controlDirectoryBucketAccessPointScope do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { account_id: 'test-value', name: 'test-value' } }

  describe ':aws_s3control_directory_bucket_access_point_scope' do
    context 'with required attributes only' do
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_s3control_directory_bucket_access_point_scope)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3control_directory_bucket_access_point_scope('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes scope when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3control_directory_bucket_access_point_scope('opt', required_attrs.merge(scope: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_s3control_directory_bucket_access_point_scope', 'opt')
        expect(config).to have_key('scope')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3control_directory_bucket_access_point_scope('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_s3control_directory_bucket_access_point_scope', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3control_directory_bucket_access_point_scope('first', required_attrs)
        synth.aws_s3control_directory_bucket_access_point_scope('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_s3control_directory_bucket_access_point_scope')
