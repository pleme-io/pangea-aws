...
# Resource: Manages a aws_s3_bucket_acl resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSS3BucketAcl do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { bucket: 'test-value' } }

  describe ':aws_s3_bucket_acl' do
    context 'with required attributes only' do
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_s3_bucket_acl)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_acl('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_s3_bucket_acl', 'full')
    ...
    context 'optional attributes' do
      ...
      it 'omits access_control_policy when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_acl('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_s3_bucket_acl', 'minimal')
        expect(config).not_to have_key('access_control_policy')
      end
      it 'includes acl when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_acl('opt', required_attrs.merge(acl: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_s3_bucket_acl', 'opt')
        expect(config).to have_key('acl')
      end
      ...
      it 'includes expected_bucket_owner when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_acl('opt', required_attrs.merge(expected_bucket_owner: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_s3_bucket_acl', 'opt')
        expect(config).to have_key('expected_bucket_owner')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_acl('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_s3_bucket_acl', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_acl('first', required_attrs)
        synth.aws_s3_bucket_acl('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_s3_bucket_acl')
