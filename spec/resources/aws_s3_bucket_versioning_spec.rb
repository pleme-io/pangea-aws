...
# Resource: Manages a aws_s3_bucket_versioning resource
  ...
  describe ':aws_s3_bucket_versioning' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        validate_required_attributes(config, [:bucket, :versioning_configuration])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_s3_bucket_versioning)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_versioning('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes expected_bucket_owner when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_versioning('opt', required_attrs.merge(expected_bucket_owner: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes mfa when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_versioning('opt', required_attrs.merge(mfa: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_s3_bucket_versioning', 'opt')
        expect(config).to have_key('mfa')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_versioning('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_s3_bucket_versioning('first', required_attrs)
        synth.aws_s3_bucket_versioning('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_s3_bucket_versioning')
