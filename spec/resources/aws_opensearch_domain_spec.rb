...
# Resource: Manages a aws_opensearch_domain resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSOpensearchDomain do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { domain_name: 'test-value' } }

  describe ':aws_opensearch_domain' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_opensearch_domain('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_opensearch_domain', 'test')
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_opensearch_domain('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_opensearch_domain)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.id).to eq("${aws_opensearch_domain.test.id}")
        expect(ref.access_policies).to eq("${aws_opensearch_domain.test.access_policies}")
        expect(ref.advanced_options).to eq("${aws_opensearch_domain.test.advanced_options}")
        expect(ref.arn).to eq("${aws_opensearch_domain.test.arn}")
        expect(ref.dashboard_endpoint).to eq("${aws_opensearch_domain.test.dashboard_endpoint}")
        expect(ref.dashboard_endpoint_v2).to eq("${aws_opensearch_domain.test.dashboard_endpoint_v2}")
        expect(ref.domain_endpoint_v2_hosted_zone_id).to eq("${aws_opensearch_domain.test.domain_endpoint_v2_hosted_zone_id}")
        expect(ref.domain_id).to eq("${aws_opensearch_domain.test.domain_id}")
        expect(ref.endpoint).to eq("${aws_opensearch_domain.test.endpoint}")
    ...
    context 'computed-only attributes' do
      it 'excludes computed-only attributes from the resource block' do
        ...
        expect(config).not_to have_key('dashboard_endpoint_v2')
        expect(config).not_to have_key('domain_endpoint_v2_hosted_zone_id')
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_opensearch_domain('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes log_publishing_options when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_opensearch_domain('opt', required_attrs.merge(log_publishing_options: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_opensearch_domain', 'opt')
        expect(config).to have_key('log_publishing_options')
      end
      ...
      it 'omits off_peak_window_options when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_opensearch_domain('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'omits software_update_options when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_opensearch_domain('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_opensearch_domain', 'minimal')
        expect(config).not_to have_key('software_update_options')
      end
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_opensearch_domain('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_opensearch_domain', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_opensearch_domain('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_opensearch_domain', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_opensearch_domain('first', required_attrs)
        synth.aws_opensearch_domain('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_opensearch_domain')
