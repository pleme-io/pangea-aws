...
# Resource: Manages a aws_cloudsearch_domain_service_access_policy resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSCloudsearchDomainServiceAccessPolicy do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { access_policy: 'test-value', domain_name: 'test-value' } }

  describe ':aws_cloudsearch_domain_service_access_policy' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        validate_required_attributes(config, [:access_policy, :domain_name])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_cloudsearch_domain_service_access_policy)
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_cloudsearch_domain_service_access_policy('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_cloudsearch_domain_service_access_policy', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_cloudsearch_domain_service_access_policy('first', required_attrs)
        synth.aws_cloudsearch_domain_service_access_policy('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_cloudsearch_domain_service_access_policy')
