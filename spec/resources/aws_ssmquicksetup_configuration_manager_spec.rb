...
# Resource: Manages a aws_ssmquicksetup_configuration_manager resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSSsmquicksetupConfigurationManager do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { name: 'test-value' } }

  describe ':aws_ssmquicksetup_configuration_manager' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ssmquicksetup_configuration_manager('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_ssmquicksetup_configuration_manager('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_ssmquicksetup_configuration_manager)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ssmquicksetup_configuration_manager('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes configuration_definition when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ssmquicksetup_configuration_manager('opt', required_attrs.merge(configuration_definition: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_ssmquicksetup_configuration_manager', 'opt')
        expect(config).to have_key('configuration_definition')
      end

      it 'omits configuration_definition when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ssmquicksetup_configuration_manager('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_ssmquicksetup_configuration_manager', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ssmquicksetup_configuration_manager('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_ssmquicksetup_configuration_manager', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ssmquicksetup_configuration_manager('first', required_attrs)
        synth.aws_ssmquicksetup_configuration_manager('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_ssmquicksetup_configuration_manager')
