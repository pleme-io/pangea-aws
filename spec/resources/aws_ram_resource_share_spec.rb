...
# Resource: Manages a aws_ram_resource_share resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSRamResourceShare do
  ...
  describe ':aws_ram_resource_share' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.aws_ram_resource_share('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_ram_resource_share('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_ram_resource_share)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ram_resource_share('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes allow_external_principals when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ram_resource_share('opt', required_attrs.merge(allow_external_principals: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_ram_resource_share', 'opt')
        expect(config).to have_key('allow_external_principals')
      end

      it 'omits allow_external_principals when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ram_resource_share('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_ram_resource_share', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'boolean fields' do
      [true, false].each do |val|
        it "accepts allow_external_principals=#{val}" do
          synth = create_synthesizer
          synth.extend(described_class)
          attrs = required_attrs.merge(allow_external_principals: val)
          synth.aws_ram_resource_share("bool_#{val}", attrs)
          result = normalize_synthesis(synth.synthesis)
          config = validate_resource_structure(result, 'aws_ram_resource_share', "bool_#{val}")
          expect(config['allow_external_principals']).to eq(val)
        end
      end
    end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ram_resource_share('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_ram_resource_share', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ram_resource_share('first', required_attrs)
        synth.aws_ram_resource_share('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_ram_resource_share')
