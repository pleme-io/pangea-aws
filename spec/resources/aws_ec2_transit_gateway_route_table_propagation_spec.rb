...
# Resource: Manages a aws_ec2_transit_gateway_route_table_propagation resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSEc2TransitGatewayRouteTablePropagation do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { transit_gateway_attachment_id: 'test-value', transit_gateway_route_table_id: 'test-value' } }

  describe ':aws_ec2_transit_gateway_route_table_propagation' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ec2_transit_gateway_route_table_propagation('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_ec2_transit_gateway_route_table_propagation)
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ec2_transit_gateway_route_table_propagation('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_ec2_transit_gateway_route_table_propagation', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_ec2_transit_gateway_route_table_propagation('first', required_attrs)
        synth.aws_ec2_transit_gateway_route_table_propagation('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_ec2_transit_gateway_route_table_propagation')
