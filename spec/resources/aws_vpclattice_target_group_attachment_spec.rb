...
# Resource: Manages a aws_vpclattice_target_group_attachment resource
  ...
  describe ':aws_vpclattice_target_group_attachment' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        validate_required_attributes(config, [:target, :target_group_identifier])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_vpclattice_target_group_attachment)
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpclattice_target_group_attachment('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpclattice_target_group_attachment('first', required_attrs)
        synth.aws_vpclattice_target_group_attachment('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_vpclattice_target_group_attachment')
