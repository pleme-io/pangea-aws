...
# Resource: Manages a aws_codecommit_repository resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSCodecommitRepository do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { repository_name: 'test-value' } }

  describe ':aws_codecommit_repository' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codecommit_repository('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_codecommit_repository', 'test')
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_codecommit_repository('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_codecommit_repository)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.id).to eq("${aws_codecommit_repository.test.id}")
        expect(ref.arn).to eq("${aws_codecommit_repository.test.arn}")
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codecommit_repository('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes default_branch when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codecommit_repository('opt', required_attrs.merge(default_branch: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codecommit_repository('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_codecommit_repository', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codecommit_repository('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_codecommit_repository', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codecommit_repository('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_codecommit_repository', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codecommit_repository('first', required_attrs)
        synth.aws_codecommit_repository('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_codecommit_repository')
