...
# Resource: Manages a aws_wafv2_regex_pattern_set resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSWafv2RegexPatternSet do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { scope: 'test-value' } }

  describe ':aws_wafv2_regex_pattern_set' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_wafv2_regex_pattern_set('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_wafv2_regex_pattern_set', 'test')
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_wafv2_regex_pattern_set('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_wafv2_regex_pattern_set)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.id).to eq("${aws_wafv2_regex_pattern_set.test.id}")
        expect(ref.arn).to eq("${aws_wafv2_regex_pattern_set.test.arn}")
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_wafv2_regex_pattern_set('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_wafv2_regex_pattern_set('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes regular_expression when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_wafv2_regex_pattern_set('opt', required_attrs.merge(regular_expression: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_wafv2_regex_pattern_set', 'opt')
        expect(config).to have_key('regular_expression')
      end

      it 'omits regular_expression when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_wafv2_regex_pattern_set('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_wafv2_regex_pattern_set', 'minimal')
        expect(config).not_to have_key('regular_expression')
      end
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_wafv2_regex_pattern_set('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_wafv2_regex_pattern_set', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_wafv2_regex_pattern_set('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_wafv2_regex_pattern_set', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_wafv2_regex_pattern_set('first', required_attrs)
        synth.aws_wafv2_regex_pattern_set('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_wafv2_regex_pattern_set')
