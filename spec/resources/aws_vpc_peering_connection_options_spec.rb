...
# Resource: Manages a aws_vpc_peering_connection_options resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSVpcPeeringConnectionOptions do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { vpc_peering_connection_id: 'test-value' } }

  describe ':aws_vpc_peering_connection_options' do
    context 'with required attributes only' do
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_vpc_peering_connection_options)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpc_peering_connection_options('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpc_peering_connection_options('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_vpc_peering_connection_options', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpc_peering_connection_options('first', required_attrs)
        synth.aws_vpc_peering_connection_options('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_vpc_peering_connection_options')
