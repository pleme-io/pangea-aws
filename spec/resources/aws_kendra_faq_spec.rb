...
# Resource: Manages a aws_kendra_faq resource
  ...
  describe ':aws_kendra_faq' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.aws_kendra_faq('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_kendra_faq', 'test')
        validate_required_attributes(config, [:index_id, :name, :role_arn, :s3_path])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_kendra_faq('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_kendra_faq)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.id).to eq("${aws_kendra_faq.test.id}")
        expect(ref.arn).to eq("${aws_kendra_faq.test.arn}")
        expect(ref.created_at).to eq("${aws_kendra_faq.test.created_at}")
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kendra_faq('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kendra_faq('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes file_format when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kendra_faq('opt', required_attrs.merge(file_format: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kendra_faq', 'opt')
        expect(config).to have_key('file_format')
      end
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kendra_faq('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kendra_faq', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kendra_faq('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_kendra_faq', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kendra_faq('first', required_attrs)
        synth.aws_kendra_faq('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_kendra_faq')
