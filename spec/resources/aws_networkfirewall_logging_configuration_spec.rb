...
# Resource: Manages a aws_networkfirewall_logging_configuration resource
  ...
  describe ':aws_networkfirewall_logging_configuration' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        validate_required_attributes(config, [:firewall_arn, :logging_configuration])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_networkfirewall_logging_configuration)
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_networkfirewall_logging_configuration('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_networkfirewall_logging_configuration('first', required_attrs)
        synth.aws_networkfirewall_logging_configuration('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_networkfirewall_logging_configuration')
