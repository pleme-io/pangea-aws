...
# Resource: Manages a aws_codebuild_report_group resource
  ...
  describe ':aws_codebuild_report_group' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.aws_codebuild_report_group('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_codebuild_report_group', 'test')
        validate_required_attributes(config, [:export_config, :name, :type])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_codebuild_report_group('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_codebuild_report_group)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codebuild_report_group('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes delete_reports when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codebuild_report_group('opt', required_attrs.merge(delete_reports: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_codebuild_report_group', 'opt')
        expect(config).to have_key('delete_reports')
      end

      it 'omits delete_reports when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codebuild_report_group('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_codebuild_report_group', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'boolean fields' do
      [true, false].each do |val|
        it "accepts delete_reports=#{val}" do
          synth = create_synthesizer
          synth.extend(described_class)
          attrs = required_attrs.merge(delete_reports: val)
          synth.aws_codebuild_report_group("bool_#{val}", attrs)
          result = normalize_synthesis(synth.synthesis)
          config = validate_resource_structure(result, 'aws_codebuild_report_group', "bool_#{val}")
          expect(config['delete_reports']).to eq(val)
        end
      end
    end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codebuild_report_group('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_codebuild_report_group('first', required_attrs)
        synth.aws_codebuild_report_group('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_codebuild_report_group')
