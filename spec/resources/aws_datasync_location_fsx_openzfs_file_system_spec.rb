...
# Resource: Manages a aws_datasync_location_fsx_openzfs_file_system resource
  ...
  describe ':aws_datasync_location_fsx_openzfs_file_system' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.aws_datasync_location_fsx_openzfs_file_system('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_datasync_location_fsx_openzfs_file_system', 'test')
        validate_required_attributes(config, [:fsx_filesystem_arn, :protocol, :security_group_arns])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_datasync_location_fsx_openzfs_file_system('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_datasync_location_fsx_openzfs_file_system)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_datasync_location_fsx_openzfs_file_system('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_datasync_location_fsx_openzfs_file_system('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_datasync_location_fsx_openzfs_file_system', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_datasync_location_fsx_openzfs_file_system('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_datasync_location_fsx_openzfs_file_system('first', required_attrs)
        synth.aws_datasync_location_fsx_openzfs_file_system('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_datasync_location_fsx_openzfs_file_system')
