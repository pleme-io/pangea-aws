...
# Resource: Manages a aws_lb_listener resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSLbListener do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { default_action: [{ 'key1' => 'val1' }], load_balancer_arn: 'test-value' } }

  describe ':aws_lb_listener' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_lb_listener('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_lb_listener('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_lb_listener)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.routing_http_request_x_amzn_mtls_clientcert_serial_number_header_name).to eq("${aws_lb_listener.test.routing_http_request_x_amzn_mtls_clientcert_serial_number_header_name}")
        expect(ref.routing_http_request_x_amzn_mtls_clientcert_subject_header_name).to eq("${aws_lb_listener.test.routing_http_request_x_amzn_mtls_clientcert_subject_header_name}")
        expect(ref.routing_http_request_x_amzn_mtls_clientcert_validity_header_name).to eq("${aws_lb_listener.test.routing_http_request_x_amzn_mtls_clientcert_validity_header_name}")
        expect(ref.routing_http_request_x_amzn_tls_cipher_suite_header_name).to eq("${aws_lb_listener.test.routing_http_request_x_amzn_tls_cipher_suite_header_name}")
        expect(ref.routing_http_request_x_amzn_tls_version_header_name).to eq("${aws_lb_listener.test.routing_http_request_x_amzn_tls_version_header_name}")
        expect(ref.routing_http_response_access_control_allow_credentials_header_value).to eq("${aws_lb_listener.test.routing_http_response_access_control_allow_credentials_header_value}")
        expect(ref.routing_http_response_access_control_allow_headers_header_value).to eq("${aws_lb_listener.test.routing_http_response_access_control_allow_headers_header_value}")
        expect(ref.routing_http_response_access_control_allow_methods_header_value).to eq("${aws_lb_listener.test.routing_http_response_access_control_allow_methods_header_value}")
        expect(ref.routing_http_response_access_control_allow_origin_header_value).to eq("${aws_lb_listener.test.routing_http_response_access_control_allow_origin_header_value}")
        expect(ref.routing_http_response_access_control_expose_headers_header_value).to eq("${aws_lb_listener.test.routing_http_response_access_control_expose_headers_header_value}")
        expect(ref.routing_http_response_access_control_max_age_header_value).to eq("${aws_lb_listener.test.routing_http_response_access_control_max_age_header_value}")
        expect(ref.routing_http_response_content_security_policy_header_value).to eq("${aws_lb_listener.test.routing_http_response_content_security_policy_header_value}")
        expect(ref.routing_http_response_server_enabled).to eq("${aws_lb_listener.test.routing_http_response_server_enabled}")
        expect(ref.routing_http_response_strict_transport_security_header_value).to eq("${aws_lb_listener.test.routing_http_response_strict_transport_security_header_value}")
        expect(ref.routing_http_response_x_content_type_options_header_value).to eq("${aws_lb_listener.test.routing_http_response_x_content_type_options_header_value}")
        expect(ref.routing_http_response_x_frame_options_header_value).to eq("${aws_lb_listener.test.routing_http_response_x_frame_options_header_value}")
        expect(ref.ssl_policy).to eq("${aws_lb_listener.test.ssl_policy}")
        expect(ref.tags_all).to eq("${aws_lb_listener.test.tags_all}")
        expect(ref.tcp_idle_timeout_seconds).to eq("${aws_lb_listener.test.tcp_idle_timeout_seconds}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_lb_listener('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_lb_listener', 'full')
    ...
    context 'optional attributes' do
      it 'includes alpn_policy when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_lb_listener('opt', required_attrs.merge(alpn_policy: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes certificate_arn when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_lb_listener('opt', required_attrs.merge(certificate_arn: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_lb_listener', 'opt')
        expect(config).to have_key('certificate_arn')
      end
      ...
      it 'includes port when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_lb_listener('opt', required_attrs.merge(port: 3.14))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_lb_listener', 'opt')
        expect(config).to have_key('port')
      end
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_lb_listener('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_lb_listener', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_lb_listener('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_lb_listener', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_lb_listener('first', required_attrs)
        synth.aws_lb_listener('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_lb_listener')
