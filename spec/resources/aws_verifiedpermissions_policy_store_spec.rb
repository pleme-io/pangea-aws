...
# Resource: Manages a aws_verifiedpermissions_policy_store resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSVerifiedpermissionsPolicyStore do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { {} }

  describe ':aws_verifiedpermissions_policy_store' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_verifiedpermissions_policy_store('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_verifiedpermissions_policy_store('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_verifiedpermissions_policy_store)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_verifiedpermissions_policy_store('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_verifiedpermissions_policy_store('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_verifiedpermissions_policy_store', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_verifiedpermissions_policy_store('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_verifiedpermissions_policy_store', 'opt')
        expect(config).to have_key('tags')
      end
      ...
      it 'includes validation_settings when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_verifiedpermissions_policy_store('opt', required_attrs.merge(validation_settings: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_verifiedpermissions_policy_store', 'opt')
        expect(config).to have_key('validation_settings')
      end

      it 'omits validation_settings when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_verifiedpermissions_policy_store('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_verifiedpermissions_policy_store', 'minimal')
        expect(config).not_to have_key('validation_settings')
      end
    end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_verifiedpermissions_policy_store('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_verifiedpermissions_policy_store', 'typed')
      end
    end
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_verifiedpermissions_policy_store('first', required_attrs)
        synth.aws_verifiedpermissions_policy_store('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_verifiedpermissions_policy_store')
