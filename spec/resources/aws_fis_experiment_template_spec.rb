...
# Resource: Manages a aws_fis_experiment_template resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSFisExperimentTemplate do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { action: [{ 'key1' => 'val1' }], description: 'test-value', role_arn: 'test-value', stop_condition: [{ 'key1' => 'val1' }] } }

  describe ':aws_fis_experiment_template' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_fis_experiment_template('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_fis_experiment_template', 'test')
        validate_required_attributes(config, [:action, :description, :role_arn, :stop_condition])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_fis_experiment_template)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_fis_experiment_template('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_fis_experiment_template', 'full')
    ...
    context 'optional attributes' do
      ...
      it 'omits experiment_options when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        ...
        expect(config).not_to have_key('experiment_options')
      end
      ...
      it 'omits experiment_report_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_fis_experiment_template('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_fis_experiment_template', 'minimal')
        expect(config).not_to have_key('experiment_report_configuration')
      end
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_fis_experiment_template('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_fis_experiment_template', 'opt')
        expect(config).to have_key('tags')
      end
      ...
      it 'includes target when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_fis_experiment_template('opt', required_attrs.merge(target: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_fis_experiment_template', 'opt')
        expect(config).to have_key('target')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_fis_experiment_template('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_fis_experiment_template', 'typed')
        expect(config['action']).to be_a(Array)
        expect(config['description']).to be_a(String)
        expect(config['role_arn']).to be_a(String)
        expect(config['stop_condition']).to be_a(Array)
      end
    end
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_fis_experiment_template('first', required_attrs)
        synth.aws_fis_experiment_template('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_fis_experiment_template')
