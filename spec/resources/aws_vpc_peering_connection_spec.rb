...
# Resource: Manages a aws_vpc_peering_connection resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSVpcPeeringConnection do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { peer_vpc_id: 'test-value', vpc_id: 'test-value' } }
  ...
  describe ':aws_vpc_peering_connection' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.aws_vpc_peering_connection('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_vpc_peering_connection', 'test')
        validate_required_attributes(config, [:peer_vpc_id, :vpc_id])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_vpc_peering_connection('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_vpc_peering_connection)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.id).to eq("${aws_vpc_peering_connection.test.id}")
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpc_peering_connection('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes auto_accept when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpc_peering_connection('opt', required_attrs.merge(auto_accept: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_vpc_peering_connection', 'opt')
        expect(config).to have_key('auto_accept')
      end
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpc_peering_connection('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_vpc_peering_connection', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'boolean fields' do
      [true, false].each do |val|
        it "accepts auto_accept=#{val}" do
          ...
          synth.aws_vpc_peering_connection("bool_#{val}", attrs)
          result = normalize_synthesis(synth.synthesis)
          config = validate_resource_structure(result, 'aws_vpc_peering_connection', "bool_#{val}")
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpc_peering_connection('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_vpc_peering_connection', 'typed')
        expect(config['peer_vpc_id']).to be_a(String)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_vpc_peering_connection('first', required_attrs)
        synth.aws_vpc_peering_connection('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_vpc_peering_connection')
