...
# Resource: Manages a aws_kinesis_firehose_delivery_stream resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSKinesisFirehoseDeliveryStream do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { destination: 'test-value', name: 'test-value' } }

  describe ':aws_kinesis_firehose_delivery_stream' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_kinesis_firehose_delivery_stream('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_kinesis_firehose_delivery_stream)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'omits elasticsearch_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        ...
        expect(config).not_to have_key('elasticsearch_configuration')
      end
      ...
      it 'omits extended_s3_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'minimal')
        expect(config).not_to have_key('extended_s3_configuration')
      end
      ...
      it 'omits http_endpoint_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'minimal')
        expect(config).not_to have_key('http_endpoint_configuration')
      end
      ...
      it 'omits iceberg_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'minimal')
        expect(config).not_to have_key('iceberg_configuration')
      end
      ...
      it 'omits kinesis_source_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'minimal')
        expect(config).not_to have_key('kinesis_source_configuration')
      end
      ...
      it 'omits msk_source_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'minimal')
        expect(config).not_to have_key('msk_source_configuration')
      end
      ...
      it 'omits opensearch_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'minimal')
        expect(config).not_to have_key('opensearch_configuration')
      end
      ...
      it 'omits opensearchserverless_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'minimal')
        expect(config).not_to have_key('opensearchserverless_configuration')
      end
      ...
      it 'omits redshift_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'omits snowflake_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'minimal')
        expect(config).not_to have_key('snowflake_configuration')
      end
      ...
      it 'omits splunk_configuration when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'minimal')
        expect(config).not_to have_key('splunk_configuration')
      end
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'opt')
        expect(config).to have_key('tags')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_kinesis_firehose_delivery_stream', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_kinesis_firehose_delivery_stream('first', required_attrs)
        synth.aws_kinesis_firehose_delivery_stream('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_kinesis_firehose_delivery_stream')
