...
# Resource: Manages a aws_sesv2_configuration_set_event_destination resource
  ...
  describe ':aws_sesv2_configuration_set_event_destination' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        validate_required_attributes(config, [:configuration_set_name, :event_destination, :event_destination_name])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:aws_sesv2_configuration_set_event_destination)
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sesv2_configuration_set_event_destination('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_sesv2_configuration_set_event_destination('first', required_attrs)
        synth.aws_sesv2_configuration_set_event_destination('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_sesv2_configuration_set_event_destination')
