...
# Resource: Manages a aws_neptune_cluster_snapshot resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::AWSNeptuneClusterSnapshot do
  ...
  describe ':aws_neptune_cluster_snapshot' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.aws_neptune_cluster_snapshot('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'aws_neptune_cluster_snapshot', 'test')
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.aws_neptune_cluster_snapshot('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:aws_neptune_cluster_snapshot)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.id).to eq("${aws_neptune_cluster_snapshot.test.id}")
        expect(ref.allocated_storage).to eq("${aws_neptune_cluster_snapshot.test.allocated_storage}")
        expect(ref.availability_zones).to eq("${aws_neptune_cluster_snapshot.test.availability_zones}")
        expect(ref.db_cluster_snapshot_arn).to eq("${aws_neptune_cluster_snapshot.test.db_cluster_snapshot_arn}")
        expect(ref.engine).to eq("${aws_neptune_cluster_snapshot.test.engine}")
        expect(ref.engine_version).to eq("${aws_neptune_cluster_snapshot.test.engine_version}")
        ...
        expect(ref.storage_encrypted).to eq("${aws_neptune_cluster_snapshot.test.storage_encrypted}")
        expect(ref.vpc_id).to eq("${aws_neptune_cluster_snapshot.test.vpc_id}")
      end
    end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_neptune_cluster_snapshot('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'aws_neptune_cluster_snapshot', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.aws_neptune_cluster_snapshot('first', required_attrs)
        synth.aws_neptune_cluster_snapshot('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'aws_neptune_cluster_snapshot')
